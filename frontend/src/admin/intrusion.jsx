...
const camOptions = [
  ...
  return (
    <div>
        <h4 style={{ marginBottom: '40px' }}>INTRUSION DETECTION</h4>
...
function RoiSelector({ cameraId }) {
  ...
  useEffect(() => {
    // This effect doesn't handle video playback, so no need for videoRef here
  }, []);
...
//     fetch('http://localhost:8081/api/intrusion', {
//       method: 'POST',
//       headers: {
...
//       });
//   };
axios.post('http://localhost:8081/api/intrusion', roiData, {
    headers: {
      'Content-Type': 'application/json',
    },
  })
